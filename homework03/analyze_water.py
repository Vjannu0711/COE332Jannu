...
# Function below calculcates the turbidity
def calculate_turbidity(listdicts: List[dict], calib: str, detect: str, i: int) -> float:
     ...
     T = a0 * I90
     return(T)
# Function below calculates the minimum decay time as well as whether the turbidity is below the threshold for safe use
